Rails.application.routes.draw do
  ...
  get '/file_uploads/errors/:id',
      to: 'file_uploads#show_processing_csv_errors',
      as: 'show_processing_csv_errors'

  get 'reports', action: 'index', controller: 'reports'
  get 'reports/lengths/:processed_file_id',
      action: 'lengths_for_measurement', controller: 'reports'
